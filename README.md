...
server:
  ingress:
    ...
    hostname: argocd.nitinkdevs.com
    aws:
...
5. add the record in route53 “argocd.nitinkdevs.com” with load balancer dns.
...
annotations:
    alb.ingress.kubernetes.io/group.name: easyshop-app-lb
    alb.ingress.kubernetes.io/scheme: internet-facing
    alb.ingress.kubernetes.io/certificate-arn: arn:aws:acm:ap-south-1:637423357842:certificate/b69bb6e7-cbd1-490b-b765-27574080f48c
    alb.ingress.kubernetes.io/target-type: ip
    alb.ingress.kubernetes.io/backend-protocol: HTTP
    alb.ingress.kubernetes.io/listen-ports: '[{"HTTP":80}, {"HTTPS":443}]'
    alb.ingress.kubernetes.io/ssl-redirect: '443'
...
- **add record to route 53 “easyshop.nitinkdevs.com”**
...
ingress:
  ...
  hosts:
    - host: logs-kibana.nitinkdevs.com
      paths:
        - path: /
```
